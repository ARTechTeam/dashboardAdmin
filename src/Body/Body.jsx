...
export default function Body() {
  return (
    <div className="bg-slate-100 dark:bg-Secondary-dark max-md:w-full items-stretch mt-20 p-5 grid grid-cols-12 gap-5 -z-50">
      ...
      <div className=" grid grid-cols-12 row-span-1 col-span-full gap-5">
