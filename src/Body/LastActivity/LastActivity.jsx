...
export default function LastActivity() {
	...
	return (
		<div className="bg-white shadow overflow-x-auto flex flex-col justify-between items-start p-7 box-border h-[482px]">
			<p className="text-2xl font-bold">LastActivity</p>
			<div className="">
				<table className="table ">
					<tbody className="">
						{data.map((item) => (
							<tr key={item.id} className="flex gap-14 p-3">
								<td className="flex gap-3 w-fit">
									<div className="w-8">{item.icon}</div>
									<div className="flex flex-col">
										<p className="truncate ">{item.title}</p>
										<p className="truncate text-sm text-black/30">{item.par}</p>
									</div>
								</td>
								<td>
									<button className="text-black/40 hover:text-Primary transition-all duration-300 uppercase">
										delete
									</button>
								</td>
								<td>
